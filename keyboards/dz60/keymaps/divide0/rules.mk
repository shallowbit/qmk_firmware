...
# debug-off:
#EXTRAFLAGS += -DNO_DEBUG -DNO_PRINT
...
# DEBUG_ENABLE = no        # Disable debugging?
NKRO_ENABLE = yes		     # USB Nkey Rollover - if this doesn't work, see here: https://github.com/tmk/tmk_keyboard/wiki/FAQ#nkro-doesnt-work
RGBLIGHT_ENABLE = yes    # Pretty lights!
TAP_DANCE_ENABLE = yes   # Tap dance keys

BACKLIGHT_ENABLE = no    # Enable keyboard backlight functionality
BACKLIGHT_BREATHING = no # I think this is led key breathing and it should be enabled by BACKLIIGHT_ENABLED
