...
#define RGBLIGHT_LAYERS
  ...
  // SEE keymap file for other BACKLIGHT tweaks
  ...
  // #define RGBLIGHT_COLOR_LAYER_0 0x46, 0xe4, 0xe4 // ---- MY TEAL
  #define RGBLIGHT_COLOR_LAYER_1 0x00, 0x00, 0xFF // BLUE
  #define RGBLIGHT_COLOR_LAYER_2 0xFF, 0x00, 0x00 // RED
  #define RGBLIGHT_COLOR_LAYER_3 0x00, 0xFF, 0x00 // GREEN
  #define RGBLIGHT_COLOR_LAYER_4 0xFF, 0xFF, 0x00 // YELLOW
  #define RGBLIGHT_COLOR_LAYER_5 0x00, 0xFF, 0xFF // AQUA
  #define RGBLIGHT_COLOR_LAYER_6 0xFF, 0x00, 0xFF // PINK
  #define RGBLIGHT_COLOR_LAYER_7 0xFF, 0xFF, 0xFF // WHITE
  #define RGBLIGHT_COLOR_LAYER_8 0x00, 0x00, 0x00 // BLACK
#endif
